...
#ifndef MODULE_CXXFILEDIALOG_H_
//@隐藏{
#define MODULE_CXXFILEDIALOG_H_
//@隐藏}
...
// 本模块是一个文件对话框的封装，可以用于文件、目录的打开和保存。该对话框是基于微软系统内建的COM组件实现的。
//@模块信息结束
...
//@解析头文件
#include "CXXCore-master\include\cxxfiledialog.h"
