...
#ifndef MODULE_CXXJSON_H_
//@隐藏{
#define MODULE_CXXJSON_H_
//@隐藏}
...
// 本模块是一个JSON的封装，可以用于JSON的序列化(转换为JSON字符串)和反序列化(从JSON字符串解析)。也支持CPP结构体 -> JSON对象的转换。
// 此模块是基于Github的开源项目nlohmann/json实现的。
//@模块信息结束
...
//@解析头文件
#include "CXXCore-master\include\cxxjson.h"
