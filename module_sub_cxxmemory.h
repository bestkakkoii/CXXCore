...
#ifndef MODULE_CXXMEMORY_H_
//@隐藏{
#define MODULE_CXXMEMORY_H_
//@隐藏}
...
// 本模块是一个内存管理的封装，可以用于本地或远程内存的读写，以及内存的分配和释放或DLL注入等。
// 本模块是基于微软系统内建的NTDLL，从用户层调用内核层的API实现。
//@模块信息结束
...
//@解析头文件
#include "CXXCore-master\include\cxxmemory.h"
