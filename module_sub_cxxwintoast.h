...
#ifndef MODULE_CXXWINTOAST_H_
//@隐藏{
#define MODULE_CXXWINTOAST_H_
//@隐藏}

//@模块名称 炫扩展模块-WinToast通知
//@版本     炫扩展-子模块
//@日期     请参考炫扩展-核心模块
//@作者     Bestkakkoii
//@依赖     "module_cxxcore.h"
...
// 本模块是一个WinToast通知的封装，可以用于WinToast通知的发送。
// 亦可自定义回调函数获取用户的点击事件。
//@模块信息结束
...
//@解析头文件
#include "CXXCore-master\include\cxxwintoast.h"
